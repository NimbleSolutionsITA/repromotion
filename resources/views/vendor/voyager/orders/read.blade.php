            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div class="panel-heading" style="border-bottom: 0;">
                        <h3 class="panel-title">Prodotti per questo ordine</h3>
                    </div>
                        ...
                        <ul>
                            @foreach($products as $product)
                                <li style="margin-bottom: 10px;">
                                    <div>Id prodotto: {{ $product->id }}</div>
                                    <div>{{ $product->name }}</div>
                                    <div>€ {{ $product->getFormattedPriceAttribute() }}</div>
                                    <div>Quantità: {{ $product->pivot->quantity }}</div>
                                </li>
                            @endforeach
                        </ul>
                    </div>
